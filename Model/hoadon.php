...
function getThongTinHHID($masohd){
    $db = new connect();
    $select = "SELECT a.tenhh, GROUP_CONCAT(DISTINCT c.idmau) as mausac, GROUP_CONCAT(DISTINCT c.idsize) as size, b.hinh, b.dongia, b.giamgia, c.soluongmua, c.thanhtien
               FROM tbl_hanghoa a, tbl_cthanghoa b, tbl_cthoadon c
