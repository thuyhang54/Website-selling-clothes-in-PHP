                        ...
                        <div class="checkout-product-details">
                            <div class="payment">
                                <div class="card-details">
                                    <form class="checkout-form" method="POST" action="index.php?action=online-checkout"
                                    ...
                                    <input id="card-cvc" class="form-control" type="tel" maxlength="4" placeholder="CVC">
                                        ...
                                        <button type="submit" name="payUrl" class="btn" style="width: 50px; height:50px; padding: 0; overflow: hidden;"><img src="https://th.bing.com/th/id/OIP.8A3oGCqKXQ3uYNyfTXyNNgAAAA?rs=1&pid=ImgDetMain" style="width: 100%; height: 100%;" alt="img Payment momo"></button>
                                        <button type="submit" name="redirect" class="btn" style="width: 50px; height:50px; padding: 0; overflow: hidden; " ><img src="https://play-lh.googleusercontent.com/2WHgcuwhtbmfrDEF-D-lYQ4sAk0TlI-aFtqx7lJXK5KV7f8smnofaedP_Opcd3edR2c" style="width: 100%; height: 100%;" alt="img Payment VnPay"></button>
                                    </form>
                                    <a href="#" id="confirmPaymentBtn" class="btn btn-main mt-10">Thanh toán tiền mặt</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        ?>
                            <div class="media product-card">
                                <a class="pull-left" href="product-single.html">
                                    <img class="media-object"
                                        src="Content/images/shop/products/<?php echo $item['hinh']; ?>"
                                        alt="ImageProduct" />
                                </a>
                                <div class="media-body">
                                    <h4 class="media-heading"><a
                                            href="product-single.html"><?php echo $item['tenhh'] ?></a></h4>
                                    <p> Phân loại: </p>
                                    <?php
                                 $hh = new hanghoa();
                                 ...
                                 while ($size = $availableSizes->fetch()) {
                                    ...
                                    <p class="price"><?php echo $item['soluong']; ?> x
                                        <?php echo $item['giamgia'] ? $item['giamgia'] : $item['dongia']; ?><sup><u>đ</u></sup>
                                    </p>
                            ...
                            <ul class="summary-prices">
                                <li>
                                    <span>Subtotal:</span>
                                    <span
                                        class="price"><?php echo number_format($item['thanhtien']); ?><sup><u>đ</u></sup></span>
                                </li>
                                <li>
                                    <span>Shipping:</span>
                                    <span>Free</span>
...
document.addEventListener('DOMContentLoaded', ()=> {
    ...
    if (confirmPaymentBtn) {
        confirmPaymentBtn.addEventListener('click', (event)=> {
            ...
            // Nếu người dùng đồng ý, chuyển hướng đến trang xác nhận thanh toán
            if (isConfirmed) {
