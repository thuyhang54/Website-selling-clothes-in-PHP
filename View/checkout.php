                        ...
                        <div class="block billing-details">
                            ...
                            <form class="checkout-form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="new_address" id="user_address" placeholder="" value="<?php echo $thongtinkh['diachi']; ?>">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="checkout-product-details">
                                <div class="payment">
                                    <div class="card-details">
                                        <form class="checkout-form" method="POST" action="index.php?action=online-checkout" onsubmit="return confirm('Xác nhận đặt hàng ?')">
                                            <!-- <div class="form-group">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (confirmPaymentBtn) {
                confirmPaymentBtn.addEventListener('click', (event) => {
                    ...
                    var isConfirmed = confirm('Xác nhận thanh toán ?');
